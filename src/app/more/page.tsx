    ...
    return [
      {
        ...
        detailedDescription: 'これは管理者用のデバッグクエストです。',
        reward: '999ポイント',
        progress: 1,
        maxProgress: 1,
        completed: true,
          ...
          const mockQuests: QuestItem[] = [
            {
              ...
              detailedDescription: '最高権限者アカウントでのログインが完了し、全ての機能にアクセス可能です。',
              reward: '999ポイント',
              progress: 1,
              maxProgress: 1,
              completed: true,
            ...
            },
            {
              ...
              detailedDescription: 'クエストの表示、作成、管理機能が正常に動作しています。',
              reward: '500ポイント',
              progress: 2,
              maxProgress: 3,
              completed: false,
            ...
            },
            {
              ...
              detailedDescription: 'システム管理機能、ユーザー管理、データベース操作等の権限を確認します。',
              reward: '1000ポイント',
              progress: 0,
              maxProgress: 1,
              completed: false,
            ...
            },
            {
              ...
              detailedDescription: '新しい機能の開発、テスト、デプロイを管理者権限で実行します。',
              reward: '750ポイント',
              progress: 1,
              maxProgress: 5,
              completed: false,
          ...
          const emergencyQuests: QuestItem[] = [
            {
              ...
              detailedDescription: 'システム管理者用の緊急クエストです',
              reward: '999ポイント',
              progress: 0,
              maxProgress: 1,
              completed: false,
            ...
            },
            {
              ...
              detailedDescription: 'システム復旧用のテストクエストです',
              reward: '500ポイント',
              progress: 0,
              maxProgress: 3,
              completed: false,
